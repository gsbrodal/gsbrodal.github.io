...
\begin{center}
  \huge
  \textbf{Introduction to Programming with \\
  Scientific Applications (Spring 2026)} \\[2ex]
  \textit{\color{red}Project title} \\[3ex]
\end{center}
\noindent
